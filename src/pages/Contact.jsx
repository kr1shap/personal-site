...
function Contact(props) {
  return (
    <div
      className="bg-[#080861] flex flex-col justify-start gap-10 p-6 md:p-10 rounded-[10px] w-full max-w-[1000px] h-auto md:h-[80vh] md:max-h-[700px] overflow-x-auto overflow-y-auto no-scrollbar"
    >
